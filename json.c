...
static const long
    ...
    /*shift size is already overflow*/
    /*=================mark==================*/
    /*flag_num_zero            = 1 << 99,*/
    flag_num_zero            = 1 << 9,
    flag_num_e                = 1 << 10,
                                     ...
                                     char * error_buf)
{
    ...
    /* Skip UTF-8 BOM 意思就是不限定是utf8型態string
     */
    ...
    /*3.沒有意義的條件設定*/
    /*===============mark==============*/
    for (state.first_pass = 1 /*state.first_pass >= 0*/; /*-- state.first_pass*/ --state.first_pass;)
    {
        json_uchar uchar;
